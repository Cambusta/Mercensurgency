#include "purgatory_functions.sqf";
#include "purgatory_displayFunctions.sqf";
...
if (hasInterface) then {
	purgatory_checkTimer = 15;
	purgatory_longLoopTimer = 30;
	
	purgatory_actionText = "<img size='1.7' shadow='5' image='A3\ui_f\data\map\markers\military\end_CA.paa'/><t color='#CCFF44' size='2'>DEPLOY</t><img size='1.7' shadow='12' image='A3\ui_f\data\map\markers\military\end_CA.paa'/>";
};



if (isServer || isDedicated) then {
	private["_b","_basicObject","_o","_to","_i","_j","_k","_length","_width"];
	_b = "Land_VR_Block_02_F";
	_initPos = [1684,5577,150];
